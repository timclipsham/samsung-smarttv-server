...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { description: @widget.description, identifier: @widget.identifier, title: @widget.title }
    end
  ...
  test "should update widget" do
    patch :update, id: @widget, widget: { description: @widget.description, identifier: @widget.identifier, title: @widget.title }
    assert_redirected_to widget_path(assigns(:widget))
  end
